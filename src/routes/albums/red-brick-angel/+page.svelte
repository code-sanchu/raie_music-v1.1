	...
	<div class="flex justify-center" in:fade>
		<div class="max-w-[900px]">
			...
			<div class="prose mt-xl text-my-black tracking-wider max-w-[650px]">
				...
				<p class="">
					Recorded in six days at Galaxy studios in Belgium, the ‘live and real’ feel of the tracks
					is distinctive and inimitably superb! Raie is joined again by <Link
