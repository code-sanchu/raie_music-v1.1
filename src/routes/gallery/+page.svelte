...
{#if mounted}
	<h2
		class="tracking-widest uppercase text-sm md:text-sm lg:text-base decoration-my-black-50/80 underline-offset-4 text-my-black-200 flex gap-xs items-center"
		in:fade>
